import { CheckCircle2, UserCheck, Zap, TrendingDown, Shield, ArrowRight, Search, FileText, Send, ClipboardList, Users, UserPlus, Brain, Star, Code, Palette, Headset } from "lucide-react";
import Link from "next/link";
import { TrustSection } from "./trust-section";

export function CompanyLanding() {
  const roles = [
    { title: "Marketing & Growth", desc: "Scale your reach with experts in social media, content, and paid ads.", tag: "Marketing", count: "390+ Experts", icon: Code },
    { title: "Graphic Design", desc: "Senior designers specialized in branding, SaaS UI/UX, and complex workflows.", tag: "Design", count: "420+ Experts", icon: Palette },
    { title: "Video Editing", desc: "Professional editors for high-impact social content and brand storytelling.", tag: "Creative", count: "215+ Experts", icon: Headset },
  ];
    ...
    <div className="flex-1">
            ...
            <div className="flex items-center justify-between gap-4 mb-0">
              <div className="flex-1 max-w-[60%] lg:max-w-xl text-left">
                ...
                <p className="text-[12px] sm:text-base lg:text-xl text-zinc-400 mb-0 leading-relaxed">
                  We connect U.S. businesses to pre-vetted global talent while giving skilled professionals access to meaningful, paid opportunities.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {roles.map((role) => (
              <div key={role.title} className="bg-white dark:bg-zinc-900 p-8 rounded-[2.5rem] shadow-sm border border-zinc-100 dark:border-zinc-800 hover:shadow-md transition-shadow group cursor-pointer">
                ...
                <p className="text-sm text-zinc-500 mb-8">{role.desc}</p>
                <div className="flex justify-between items-center mt-auto pt-6 border-t border-zinc-50 dark:border-zinc-800">
                  <span className="text-xs font-bold text-zinc-400 uppercase tracking-widest">{role.count}</span>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-[#F8F3F5] dark:bg-zinc-900/50 rounded-[3rem] p-8 lg:p-16 flex flex-col">
              ...
              <button className="bg-[#C2185B] text-white py-4 px-8 rounded-2xl font-bold hover:bg-[#A3154D] transition-colors cursor-pointer mt-auto w-fit">
                Start hiring
              </button>
            </div>

            {/* How hiring works card */}
            <div className="bg-[#1A1A1A] rounded-[3rem] p-8 lg:p-16 text-white">
              ...
              <div className="space-y-6">
                {[
                  ...
                  { step: "Step 2", title: "Review vetted talent", desc: "Focus on curated profiles already screened for quality and readiness." },
                  { step: "Step 3", title: "Interview and hire", desc: "Move quickly from shortlist to interviews and final decisions." }
                ].map((item) => (
      ...
      <section className="py-24 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#1A1A1A] rounded-[3rem] p-12 lg:p-20 relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-12 shadow-2xl">
          ...
          <button className="relative z-10 bg-[#C2185B] text-white px-10 py-4 rounded-2xl font-bold hover:bg-[#A3154D] transition-colors shadow-lg shadow-pink-500/20 cursor-pointer">
            Start hiring
          </button>
        </div>
      </section>
